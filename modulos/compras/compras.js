...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.status) {
                    ...
                    setTimeout(function () {
                        location.href = res.pagina
                        window.open(urlApp + "app/report/reporte-compra.php?cps_id=" + res.cps_id, "_blank", "toolbar=no,scrollbars=yes,resizable=yes,top=100,right=100,width=700,height=700");
                    }, 1000);
    ...
    function listarProveedores() {
        ...
        $.ajax({
            type: "POST",
            url: urlApp + 'app/modulos/proveedores/proveedores.ajax.php',
            data: datos,
            dataType: "json",
            processData: false,
            contentType: false,
    ...
    $("#autocomplete_pts").autocomplete({
        source: urlApp + 'app/modulos/compras/compras.ajax.php',
    ...
    $("#tbodylistarcompras").on("click", "button.btnImprimirReporte", function () {
        ...
        window.open(urlApp + "app/report/reporte-compra.php?cps_id=" + cps_id, "_blank", "toolbar=no,scrollbars=yes,resizable=yes,top=100,right=100,width=700,height=700");
