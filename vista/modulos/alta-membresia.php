<div class="container">
    ...
    <div class="row d-none " id="cntn-membresia">
        <div class="col">
            <form name="form-NuevaMembresia" id="form-NuevaMembresia" method="post">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="GDidCliente" id="GDidCliente">
                                        <div class="col-12 col-md-6">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="date" name="GDateInicio" class="form-control today" id="GDateinicio" placeholder="Inicio Membresia">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="date" name="GDateTermino" class="form-control" id="GDateTermino" placeholder="Termino Membresia">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <label class="" for="GDMembresia">Tipo de Membresia</label>
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i class="fas fa-barcode"></i></div>
                                                </div>
                                                
                                                <select name="GDMembresia" class="form-control" id="GDMembresia" required>
                                                    ...
                                                    ?>
                                                        <option mbs="<?php echo $mbs['mbs_id'] ?>"><?php echo $mbs['mbs_tipo'] ." $ ".$mbs['mbs_costo'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-cancelarCliente" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button id="btn-CrearMembresia" class="btn btn-primary" name="btnCrearMembresia">Guardar Membresia</button>
                </div>
                <?php
                // $cliente = new ClientesControlador();
                //$cliente->ctrAgregarCliente();
